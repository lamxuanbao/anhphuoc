...
class PropertyRepository extends BaseRepository
{
    ...
    public function getList($params)
    {
        ...
        if (isset($params['is_active'])) {
            $query = $query->where('is_active', (boolean)$params['is_active']);
        }
...
//    }
    ...
    {
        parent::update($attributes, $id); // TODO: Change the autogenerated stub
        if (isset($attributes['remove_files']) && is_array($attributes['remove_files'])) {
            PropertyImages::where('property_id', $id)
                ->whereIn('id', $attributes['remove_files'])
                ->delete();
        }
        $images = [];
        if (isset($attributes['files']) && is_array($attributes['files'])) {
