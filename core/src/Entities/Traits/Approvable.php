...
use App\Common\Models\Traits\Approval\ApprovableObserver;
use App\Common\Models\Traits\Approval\ApprovalEvents;
use App\Common\Models\Traits\Approval\ApprovalRequired;
use App\Common\Models\Traits\Approval\ApprovalScope;
use App\Common\Models\Traits\Approval\ApprovalStatuses;
use Exception;
...
trait Approvable
{
    ...
    public function getApprovalByColumn()
    {
        return defined('static::APPROVAL_BY') ? static::APPROVAL_BY : 'approval_by';
    }
