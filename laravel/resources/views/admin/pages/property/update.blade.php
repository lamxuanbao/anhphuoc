...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('admin.property.update',$property->id) }}" novalidate="novalidate"
            ...
            <div class="card card-custom">
                ...
                <div class="card-footer text-right">
                    ...
                    @if(!$property->is_active)
                        <a href="{{route('admin.property.active',$property->id)}}" class="btn btn-success mr-2">
                            Duyệt
                        </a>
                    @else
                        <a href="{{route('admin.property.active',$property->id)}}" class="btn btn-success mr-2">
